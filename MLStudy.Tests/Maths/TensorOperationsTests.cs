...
namespace MLStudy.Tests.Maths
{
    public class TensorOperationsTests
    {
        ...
        public void AddVectorScalar()
        {
            ...
            var actual = TensorOperations.Instance.Add(a, b);
        ...
        public void MultipleVectorScalar()
        {
            ...
            var actual = TensorOperations.Instance.Multiple(a, b);
        ...
        public void MultipleVectorVector()
        {
            var a = new Vector(1, 2, 3, 4, 5, 6);
            var b = new Vector(7, 8, 9, 10, 11, 12);
            var expected = new Vector(7, 16, 27, 40, 55, 72).Sum();
        ...
        public void MultipleMatrixVector()
        {
            ...
            var expected = new Matrix(new double[,]{
                { 50 },
                { 122 }});
            var actual = TensorOperations.Instance.Multiple(a, v);
        ...
        public void MultipleVectorMatrix()
        {
            ...
            var expected = new Matrix(new double[,]{
                { 39, 54, 69 }});
            var actual = TensorOperations.Instance.Multiple(v, a);
