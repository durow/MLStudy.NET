...
namespace MLStudy.Tests.Maths
{
    public class TensorTests
    {
        ...
        public void CreateTest3()
        {
            ...
            var t = new TensorOld(data, 1, 3, 3);
        ...
        public void AddTest()
        {
            var a = new TensorOld(new double[,] { { 1, 2, 3 }, { 4, 5, 6 } });
            var b = new TensorOld(new double[,] { { 3, 2, 1 }, { 6, 5, 4 } });

            var a10 = a + 10;
            var a10r = 10 + a;
            var a10Expected = new TensorOld(new double[,] { { 11, 12, 13 }, { 14, 15, 16 } });
            Assert.Equal(a10Expected, a10);
            Assert.Equal(a10Expected, a10r);

            var ab = a + b;
            var abr = b + a;
            var abExpected = new TensorOld(new double[,] { { 4, 4, 4 }, { 10, 10, 10 } });
        ...
        public void MinusTest()
        {
            ...
            var a10 = a - 10;
            var a10Expected = new TensorOld(new double[,] { { -9, -8, -7 }, { -6, -5, -4 } });
            Assert.Equal(a10Expected, a10);

            var a10r = 10 - a;
            var a10rExpected = new TensorOld(new double[,] { { 9, 8, 7 }, { 6, 5, 4 } });
            Assert.Equal(a10rExpected, a10r);

            var ab = a - b;
            var abExpected = new TensorOld(new double[,] { { -2, 0, 2 }, { -2, 0, 2 } });
            Assert.Equal(abExpected, ab);
        }
        ...
        public void MultipleTest()
        {
            ...
            var c = new TensorOld(new double[,] { { 1, 2, 3 }, { 4, 5, 6 } });
            var d = new TensorOld(new double[,] { { 1, 2 }, { 3, 4 }, { 5, 6 } });
            var e = new TensorOld(new double[,] { { 3, 2, 1 }, { 6, 5, 4 } });
            ...
            var ceewExpected = new TensorOld(new double[,] { { 3, 4, 3 }, { 24, 25, 24 } });
        ...
        public void TransposeTest()
        {
            ...
            var expected = new TensorOld(new double[,] { { 1, 4 }, { 2, 5 }, { 3, 6 } });
